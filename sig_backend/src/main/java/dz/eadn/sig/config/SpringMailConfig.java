...
public class SpringMailConfig {
	 ...
	 * mailSender.setPort(25); mailSender.setProtocol("smtp");
	 * 
	 * // create java mail properties Properties mailProperties = new Properties();
	...
	/*
	 * private ITemplateResolver fileTemplateResolver() { FileTemplateResolver
	 * templateResolver = new FileTemplateResolver();
	 * templateResolver.setPrefix("/Emailer/templates/"); //Change based on your
	 * environment templateResolver.setSuffix(".html");
	 * templateResolver.setTemplateMode(TemplateMode.HTML);
	 * templateResolver.setCharacterEncoding("UTF8");
	 * templateResolver.setCheckExistence(true);
	 * templateResolver.setCacheable(false); return templateResolver; }
	 * 
	 * @Bean(name = "fileTemplateEngine") public TemplateEngine fileTemplateEngine()
	 * { TemplateEngine templateEngine = new TemplateEngine();
	 * templateEngine.addTemplateResolver(fileTemplateResolver()); return
	 * templateEngine; }
	 */
